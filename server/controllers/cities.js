...
import validCity from "@validations/city";
...
class CityController {
  ...
  static async create(req, res, next) {
    const apilog = {
      name: `${CityController.parameters.toLowerCase()}.create`,
      refid: randString(`${CityController.parameter.toUpperCase()}`),
      reqbody: JSON.stringify(req.body),
      resbody: "",
      httpstatuscode: 201,
      statuscode: 201,
      message: `${CityController.parameter} created successfully`,
      apiref: v4(),
    ...
    try {
      const { errors, isValid } = validCity(req.body);
      // Check Validation
      if (!isValid) {
      ...
      return ResponseController.success(
        ...
        201,
        201,
        `${CityController.parameter} created successfully`,
        payload
      );
    } catch (err) {
      ...
      apilog.httpstatuscode = 400;
      apilog.statuscode = 400;
      apilog.message = `${CityController.parameter} could not be created`;
      ...
      return ResponseController.error(
        ...
        400,
        400,
        `${CityController.parameter} creation unsuccessful`,
        err
      );
    }
  }
  ...
  static async update(req, res, next) {
    const apilog = {
      name: `${CityController.parameters.toLowerCase()}.update`,
      refid: randString(`${CityController.parameter.toUpperCase()}`),
      reqbody: JSON.stringify(req.body),
      resbody: "",
      httpstatuscode: 200,
      statuscode: 200,
      message: `${CityController.parameter} updated successfully`,
      apiref: v4(),
      url: `${req.method} ~ ${req.originalUrl}`,
      reqstarttime: Date.now(),
      reqendtime: "",
    ...
    try {
      const { errors, isValid } = validCity(req.body, true);
      // Check Validation
      if (!isValid) {
        apilog.resbody = JSON.stringify(errors);
        apilog.httpstatuscode = 400;
      ...
      const payload = await City.update(req.body, {
        returning: true,
        where: { id },
      });
      ...
      return ResponseController.success(
        ...
        200,
        200,
        `${CityController.parameter} updated successfully`,
        payload
      );
    } catch (err) {
      apilog.resbody = JSON.stringify(err);
      apilog.httpstatuscode = 400;
      apilog.statuscode = 400;
      apilog.message = `${CityController.parameter} could not be updated`;
      apilog.reqendtime = Date.now();
      await ApiLogs.create({ ...apilog });
      ...
      return ResponseController.error(
        ...
        400,
        400,
        `${CityController.parameter} could not be updated`,
        err
      );
    }
  }
  ...
  static async delete(req, res, next) {
    const apilog = {
      name: `${CityController.parameters.toLowerCase()}.delete`,
      refid: randString(`${CityController.parameter.toUpperCase()}`),
      reqbody: JSON.stringify(req.body),
      resbody: "",
      httpstatuscode: 200,
      statuscode: 200,
      message: `${CityController.parameter} deleted successfully`,
      apiref: v4(),
      url: `${req.method} ~ ${req.originalUrl}`,
      reqstarttime: Date.now(),
      reqendtime: "",
    ...
    try {
      ...
      return ResponseController.success(
        ...
        200,
        200,
        `${CityController.parameter} deleted successfully`,
        payload
      );
    } catch (err) {
      apilog.resbody = JSON.stringify(err);
      apilog.httpstatuscode = 400;
      apilog.statuscode = 400;
      apilog.message = `${CityController.parameter} could not be deleted`;
      apilog.reqendtime = Date.now();
      await ApiLogs.create({ ...apilog });
      ...
      return ResponseController.error(
        ...
        400,
        400,
        `${CityController.parameter} could not be deleted`,
        err
      );
    }
  }
